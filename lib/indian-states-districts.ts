...
export const INDIAN_STATES_DISTRICTS: State[] = [
  {
    name: "Andhra Pradesh",
    districts: ["Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool", "Prakasam", "Nellore", "Srikakulam", "Visakhapatnam", "Vizianagaram", "West Godavari", "YSR Kadapa"]
  },
  {
...
export const getStateNames = (): string[] => {
  return INDIAN_STATES_DISTRICTS.map(state => state.name).sort()
}
