          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                education, and healthcare. We envision thriving communities that are self-sufficient,
                environmentally conscious, and socially inclusive, where no one is left behind
