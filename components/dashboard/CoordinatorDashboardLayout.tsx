...
const navigation: NavItem[] = [
  ...
  {
    name: 'My Referrals',
    href: '/dashboard/coordinator/referrals',
    icon: Share2,
...
export default function CoordinatorDashboardLayout({ children }: CoordinatorDashboardLayoutProps) {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-900">Coordinator</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
            ...
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-green-600 font-medium">
                  {session?.user?.role === 'COORDINATOR' ? 'Coordinator' : 'Sub-Coordinator'}
                </p>
              </div>
            </div>
            <button
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">
                  {navigation.find(item => item.href === pathname)?.name || 'Coordinator Dashboard'}
                </h1>
                <p className="text-sm text-gray-500 mt-1">
                  {navigation.find(item => item.href === pathname)?.description || 'Manage your coordination activities'}
                </p>
              </div>
            </div>
